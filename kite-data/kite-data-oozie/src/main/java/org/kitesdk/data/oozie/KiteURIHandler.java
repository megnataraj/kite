...
/**
 * A Kite URI handler that works with signaled views.
 *
 * When checking "exists" the view must have been signaled as ready.
 */
public class KiteURIHandler implements URIHandler {

  private static final Logger LOG = LoggerFactory.getLogger(KiteURIHandler.class);
